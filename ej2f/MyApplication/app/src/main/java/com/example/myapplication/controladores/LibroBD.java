...
public class LibroBD extends SQLiteOpenHelper implements InterfaceLibroBD {
    ...
    public List<Libro> lista() {
        ...
        if (cursor.moveToFirst()){
            do {
                librosList.add(new Libro(cursor.getInt(0),
                        cursor.getString(1),
                        cursor.getString(2),
                        cursor.getString(3),
                        cursor.getString(4),
    ...
    public void actualizar(int id, Libro book) {
        ...
        db.update("libros", values, "_id", params);
